...
class OpGametrade(SiteOperations):
    def __init__(self, chrome, main_url, cookies_file_name, image, sheet_url, account_id, debug_mode=False):
        ...
        self.config = {
            ...
            "title_predict_xpath" : "//ul[@id='ui-id-1' and contains(@class, 'ui-autocomplete')]//li[@class='ui-menu-item']//div[@class='ui-menu-item-wrapper' and normalize-space(text())='APEX Legends']",
