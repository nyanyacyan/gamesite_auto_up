...
class OpGametrade(SiteOperations):
    def __init__(self, chrome, main_url, cookies_file_name, debug_mode=False):
        ...
        super().__init__(chrome, main_url, cookies_file_name, self.config, debug_mode=debug_mode)
